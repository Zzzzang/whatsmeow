...
func (x *DeviceProps_HistorySyncConfig) GetSupportManusHistory() bool {
	if x != nil && x.SupportManusHistory != nil {
		return *x.SupportManusHistory
	}
	return false
}
...
const file_waCompanionReg_WACompanionReg_proto_rawDesc = "" +
	"\n" +
	"#waCompanionReg/WACompanionReg.proto\x12\x0eWACompanionReg\"\xb9\x0f\n" +
	...
	"\x11historySyncConfig\x18\x05 \x01(\v2-.WACompanionReg.DeviceProps.HistorySyncConfigR\x11historySyncConfig\x1a\x83\t\n" +
	...
	"\x16thumbnailSyncDaysLimit\x18\x13 \x01(\rR\x16thumbnailSyncDaysLimit\x120\n" +
	"\x13supportManusHistory\x18\x15 \x01(\bR\x13supportManusHistory\x1a\x9a\x01\n" +
	"\n" +
	"AppVersion\x12\x18\n" +
